...
int main()
{
    ...
    while(pc >= 0 && pc < max_pc){
        ...
        fileo<<"CYCLE "<<clock_cycle<<" starts:"<<endl<<endl;
        ...
        if(mem_wb_reg.id != "nop"){
            ...
            //     if (mem_wb_reg.write_reg == id_ex_reg.read_reg_1 || mem_wb_reg.write_reg == id_ex_reg.read_reg_2)
            //     {
        ...
        if(id_ex_reg.id != "nop"){
            ...
            //stalling for Data hazard 1 -------------------------------------------------------------------------------------------------------------------------------------------------------

            string y = id_ex_reg.id;

            if((y == "add"||y=="sub"||y=="sll"||y=="srl"||y=="lw") && id_ex_reg.write_reg !=0){
    ...
    fileo << endl;
    fileo << "Total clock cycles taken by the program: " << clock_cycle << endl<<endl;
